...
oiq.src = document.location.protocol + '//px.owneriq.net/stas/s/nwnat.js';
...
<?php if(get_field('local_reach_remarketing_code')) { echo get_field('local_reach_remarketing_code'); } ?>
