...
<!-- start smc custom crumbs for single-product -->
<p class="breadcrumb"><a href="/">Home</a><a href="/products">Products</a>
<span class='current_crumb'><?php echo get_the_title($ID); ?> </span></p>
<!-- end smc custom crumbs for single-product -->
