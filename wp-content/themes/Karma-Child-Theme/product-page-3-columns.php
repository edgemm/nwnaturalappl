<?php
/*
Template Name: Product Page :: 3 Columns
*/
?>
<?php get_header(); ?>
</div><!-- header-area -->
...
<div class="portfolio_content_top_three_smc">
...
$html = truethemes_generate_portfolio_image_smc($image_src,$image_width,$image_height,$linkpost,$portfolio_full,$phototitle,'3'); 
